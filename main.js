const projectData = {
  ...
  "newest-project": {
    ...
    tags: ["HTML", "CSS", "JavaScript", "Experimental"],
    description:
      "โปรเจกต์ทดลองล่าสุดของฉัน ที่ตั้งใจผลักขอบเขตของการพัฒนาเว็บให้ก้าวไปไกลกว่าเดิม โปรเจกต์นี้สะท้อนการเดินทางสู่พื้นที่ใหม่ของการพัฒนาเฟรอนต์เอนด์ โดยมุ่งเน้นประสบการณ์ผู้ใช้ที่แปลกใหม่และสร้างสรรค์ มากกว่าจะยึดตามความต้องการของตลาด",
    features: [
      "แอนิเมชันและเอฟเฟกต์ CSS",
      "ฟังก์ชันการทำงานแบบโต้ตอบด้วย JavaScript",
      "การออกแบบแบบ Responsive รองรับทุกอุปกรณ์",
      "การใช้ Web APIs สมัยใหม่อย่างสร้างสรรค์",
      "UI/UX แบบทดลอง",
      "โครงสร้างโค้ดที่ถูก опtimized",
    ],
    liveLink: "#",
